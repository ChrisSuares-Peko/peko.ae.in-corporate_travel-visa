...
const TIMELINE_STEPS = [
  { label: 'Application Created', date: '25 Jan 2025', done: true },
  { label: 'Application Submitted', date: '26 Jan 2025', done: true },
  { label: 'Documents Under Review', date: '28 Jan 2025', current: true },
  { label: 'Embassy Submission', date: 'Pending', pending: true },
  { label: 'Visa Issued / Closed', date: 'Pending', pending: true },
]
        ...
        <div style={{ flex: '1 1 420px', minWidth: 0, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid #EBEBEB', borderRadius: 14, padding: '22px 24px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
            ...
            {TIMELINE_STEPS.map((step, i) => (
              <div key={i} style={{ display: 'flex', gap: 14, paddingBottom: i < TIMELINE_STEPS.length - 1 ? 20 : 0 }}>
